...
export function Footer() {
  return (
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16"> {/* Padding naik dari 12 ke 16 */}
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-[14px] text-gray-500 font-medium">
